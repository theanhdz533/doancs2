...
<body onload="time()" class="app sidebar-mini rtl">
    <!-- Navbar-->
    <li style="list-style: none;"><a class="app-nav__item" href="/"><i class='bx bx-log-out bx-rotate-180'></i>
        </a>
        <!-- Sidebar menu-->
    ...
    <main class="app-content" style="margin-top: -0px;">
        <div class="app-title">
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item active"><a href="#"><b>Danh sách khách hàng đặt lịch
                            hẹn</b></a></li>
            </ul>
            <div id="clock"></div>
        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($cart as $data)
                                    <tr>
                                        ...
                                        @else
                                            <td><button
                                                    style="background-color: aquamarine;color:red; width: 100%;"><b><i>Hẹn
                                                            thành công!</i></b></button></td>
                                           
                                        @endif
                                        <td>
                                            <a href="/HomeCart/{{ $data['id'] }}"
                                                style="text-decoration:block;"><b><u><i> Xem chi tiết
                                                            đơn
                                                            hàng</i></u></b></a>
                                        </td>
                                    @endif
