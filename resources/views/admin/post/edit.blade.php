        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form class="row" action="/post/{{ $post->id }}" method="POST"
                            enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group  col-md-4">
                                <label class="control-label">Người Đăng</label>
                                <input class="form-control" type="text" value="anhvt.21it@vku.udn.vn"
                                    name="email" readonly>
                            </div>
                            <div class="form-group  col-md-4">
                            ...
                            <div class="form-group  col-md-4">
                                ...
                                <input class="form-control" type="text" value="{{ $post->type_car }}"
                                    name="type_car">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Năm Sản Xuất</label>
                                <input class="form-control" type="date" value="{{ $post->year_of_manufacture }}"
                                    name="year_of_manufacture">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Quãng Đường Đã Di Chuyển</label>
                                <input class="form-control" type="text" value="{{ $post->mileage }}"
                                    name="mileage">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Nhiên Liệu</label>
                                <input class="form-control" type="text" value="{{ $post->fuel }}"
                                    name="fuel">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Đông Cơ</label>
                                <input class="form-control" type="text" value="{{ $post->engine_size }}"
                                    name="engine_size">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Mã Lực</label>
                                <input class="form-control" type="text" value="{{ $post->power }}"
                                    name="power">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Màu Sắc</label>
                                <input class="form-control" type="text" value="{{ $post->color }}"
                                    name="color">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Số Ghế</label>
                                <input class="form-control" type="text" value="{{ $post->seat_count }}"
                                    name="seat_count">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Giá</label>
                                <input class="form-control" type="text" value="{{ $post->price }}"
                                    name="price">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Số Lượng Hàng</label>
                                <input class="form-control" type="number" value="{{ $post->count }}"
                                    name="count">
                            </div>
                            <div class="form-group  col-md-4">
                                <label class="control-label">Hãng Xe</label>
                                <input class="form-control" type="text" value="{{ $post->the_firm }}"
                                    name="the_firm">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div id="myfileupload">
                                    ...
                                    @foreach ($product as $data)
                                            ...
                                            <img class="img-card-person"
                                                src="{{ url('admin/csdl/product/') }}{{ '/' }}{{ $data->image }}"
                                                alt="" style="width:20%;height:100%;float:left;">
